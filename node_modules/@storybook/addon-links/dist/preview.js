...
exports.withLinks = exports.hrefTo = exports.linkTo = exports.openLink = undefined;
...
var withLinks = exports.withLinks = function withLinks(story) {
  _addons2.default.getChannel().emit(_coreEvents2.default.REGISTER_SUBSCRIPTION, linkSubscribtion);
  return story();
};