...
exports.defaultDecorateStory = undefined;
...
var _subscriptions_store2 = _interopRequireDefault(_subscriptions_store);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var defaultDecorateStory = exports.defaultDecorateStory = function defaultDecorateStory(getStory, decorators) {
...
var metaSubscription = function metaSubscription() {
  _addons2.default.getChannel().on(_coreEvents2.default.REGISTER_SUBSCRIPTION, _subscriptions_store2.default.register);
  return function () {
    return _addons2.default.getChannel().removeListener(_coreEvents2.default.REGISTER_SUBSCRIPTION, _subscriptions_store2.default.register);
  };
};

var withSubscriptionTracking = function withSubscriptionTracking(storyFn) {
  if (!_addons2.default.hasChannel()) return storyFn();
  _subscriptions_store2.default.markAllAsUnused();
  _subscriptions_store2.default.register(metaSubscription);
  var result = storyFn();
  _subscriptions_store2.default.clearUnused();
  return result;
};
...
var ClientApi = function ClientApi() {
  ...
  this.storiesOf = function (kind, m) {
    ...
    api.add = function (storyName, getStory, parameters) {
      ...
      var decorators = [].concat(localDecorators, (0, _toConsumableArray3.default)(_this._globalDecorators), [withSubscriptionTracking]);
