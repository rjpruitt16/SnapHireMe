...
var ReactProvider = function (_Provider) {
  ...
  function ReactProvider() {
    ...
    _this.channel.emit(_coreEvents2.default.CHANNEL_CREATED);
    return _this;
  }
  ...
  (0, _createClass3.default)(ReactProvider, [{
    ...
    value: function handleAPI(api) {
      ...
      api.onStory(function (kind, story) {
        _this2.channel.emit(_coreEvents2.default.SET_CURRENT_STORY, { kind: kind, story: story });
      });
      this.channel.on(_coreEvents2.default.SET_STORIES, function (data) {
        api.setStories(data.stories);
      });
      this.channel.on(_coreEvents2.default.SELECT_STORY, function (data) {
        api.selectStory(data.kind, data.story);
      });
      this.channel.on(_coreEvents2.default.APPLY_SHORTCUT, function (data) {
