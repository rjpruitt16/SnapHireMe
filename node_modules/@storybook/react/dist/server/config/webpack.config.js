...
exports.default = function (configDir, quiet) {
  var config = {
    ...
    plugins: [new _htmlWebpackPlugin2.default({
      ...
      template: _server.iframeHtmlPath
    }), new _InterpolateHtmlPlugin2.default(process.env), new _webpack2.default.DefinePlugin((0, _utils.loadEnv)()), new _webpack2.default.HotModuleReplacementPlugin(), new _caseSensitivePathsWebpackPlugin2.default(), new _WatchMissingNodeModulesPlugin2.default(_utils.nodeModulesPaths), quiet ? null : new _webpack2.default.ProgressPlugin(), new _dotenvWebpack2.default({ silent: true })].filter(Boolean),
    module: {
      rules: [{
        test: /\.jsx?$/,
